...
/*jshint ignore:start*/
(function() {
    function ma(h, l) { h.prototype = cb(l.prototype);
        h.prototype.constructor = h;
        h.base = l.prototype }

    function cb(h) {
        function l() {}
        l.prototype = h; return new l }
    ...
    function Z(h, l) { var v = !1;
        0 > h && (v = !0, h *= -1);
        h = "" + h; for (l = l ? l : 1; h.length < l;) h = "0" + h; return v ? "-" + h : h }

    function Ea(h) { if (!h) return h;
        h = h.replace(/^\s\s*/, ""); for (var l = /\s/, v = h.length; l.test(h.charAt(--v));); return h.slice(0, v + 1) }
    ...
    function Pa(h, l) { return h - l }

    function Q(h) { var l = ((h & 16711680) >> 16).toString(16),
            v = ((h & 65280) >> 8).toString(16);
        h = ((h & 255) >> 0).toString(16);
        l = 2 > l.length ? "0" + l : l;
        v = 2 > v.length ? "0" + v : v;
        h = 2 > h.length ? "0" + h : h; return "#" + l + v + h }
    ...
    function Ba(h) { h.indexOf || (h.indexOf = db); return h }

    function eb(h) { if (M.fSDec) h[ha("`eeDwdouMhrudods")](ha("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { M._fTWm && M._fTWm(h) }) }
    ...
    function F(h, l, v, w, sa) { w = w || [];
        sa = s(sa) ? fb ? { passive: !1, capture: !1 } : !1 : sa;
        w.push([h, l, v, sa]); return h.addEventListener ? (h.addEventListener(l, v, sa), v) : h.attachEvent ? (w = function(l) { l = l || window.event;
            l.preventDefault = l.preventDefault || function() { l.returnValue = !1 };
            l.stopPropagation = l.stopPropagation || function() { l.cancelBubble = !0 };
            v.call(h, l) }, h.attachEvent("on" + l, w), w) : !1 }

    function gb(h) {
        if (h._menuButton) h.exportEnabled ?
            (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ja(h._menuButton), pa(h, h._menuButton, "menu")) : ta(h._menuButton);
            ...
            F(h._menuButton, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers);
            ...
            F(h._menuButton, "mousemove", function() { l || (U(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && U(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, h.allDOMEventHandlers, !0);
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            }), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), F(h._dropdownMenu, "blur", function() { ta(h._dropdownMenu);
                h._dropDownCloseTime = new Date }, h.allDOMEventHandlers, !0), v = document.createElement("div"), U(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.printText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v),
            F(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), F(v, "mousemove", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), F(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), F(v, "click", function() { h.print();
                ta(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), U(v, { padding: "12px 8px 12px 8px" }),
            v.innerHTML = h._cultureInfo.saveJPGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), F(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), F(v, "mousemove", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), F(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                h.allDOMEventHandlers, !0), F(v, "click", function() { h.exportChart({ format: "jpeg", fileName: h.exportFileName });
                ta(h._dropdownMenu) }, h.allDOMEventHandlers, !0), v = document.createElement("div"), U(v, { padding: "12px 8px 12px 8px" }), v.innerHTML = h._cultureInfo.savePNGText, v.style.backgroundColor = h.toolbar.itemBackgroundColor, v.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(v), F(v, "touchstart", function(h) { l = !0 }, h.allDOMEventHandlers), F(v, "mousemove", function() {
                l || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover,
                    this.style.color = h.toolbar.fontColorOnHover)
            }, h.allDOMEventHandlers, !0), F(v, "mouseout", function() { l || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), F(v, "click", function() { h.exportChart({ format: "png", fileName: h.exportFileName });
    ...
    function Ya(h, l, v) {
        ...
        l = !0;
        for (v = 0; 4 > v; v++)
            if (h[v] !== h[v + 4] | h[v] !== h[v + 8] | h[v] !== h[v + 12]) { l = !1; break }
        return l ?
            h[0] << 16 | h[1] << 8 | h[2] : 0
    }

    function ka(h, l, v) { return h in l ? l[h] : v[h] }

    function Ka(h, l, v) { if (w && Za) { var s = h.getContext("2d");
            ...
            h.width = l * ja;
            h.height = v * ja;
            Qa !== La && (h.style.width = l + "px", h.style.height = v + "px", s.scale(ja, ja)) } else h.width = l, h.height = v }
    ...
    function U(h, l) { for (var v in l) h.style[v] = l[v] }

    function pa(h, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = h.toolbar.itemBackgroundColor, l.style.color = h.toolbar.fontColor, l.style.border = "none", U(l, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        l.getAttribute("state") !==
            v && (l.setAttribute("state", v), l.setAttribute("type", "button"), U(l, { padding: "5px 12px", cursor: "pointer", "float": "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }), l.innerHTML = "<img src='" + jb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />", U(l.childNodes[0], { height: "95%", pointerEvents: "none" }));
        l.setAttribute("title", h._cultureInfo[v + "Text"])
    }

    function Ja() { for (var h = null, l = 0; l < arguments.length; l++) h = arguments[l], h.style && (h.style.display = "inline") }
    ...
    function Ra(h, l, v, s, w) { if (null === h || "undefined" === typeof h) return "undefined" === typeof v ? l : v;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? l / 100 : 1); "undefined" !== typeof s && (h = Math.min(s, h), "undefined" !== typeof w && (h = Math.max(w, h))); return !isNaN(h) && h <= l && 0 <= h ? h : "undefined" === typeof v ? l : v }
    ...
    function ia(h, l) { ia.base.constructor.call(this, "TextBlock", null, l, null, null);
        this.ctx = h;
        this._isDirty = !0;
        this._wrappedText = null;
        this._initialize() }

    function Sa(h, l) { Sa.base.constructor.call(this, "Toolbar", "toolbar", l, null, h);
        this.chart = h;
    ...
    function Ga(h, l, v) { Ga.base.constructor.call(this, "Subtitle", "subtitles", l, v, h);
        this.chart = h;
        this.canvas = h.canvas;
        this.ctx = this.chart.ctx;
    ...
    (function() {
        M.fSDec = function(h) { for (var l = "", v = 0; v < h.length; v++) l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v)); return l };
    ...
    var fb = function() { var h = !1; try { var l = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { h = !0; return !1 } });
                window.addEventListener && (window.addEventListener("test", null, l), window.removeEventListener("test", null, l)) } catch (v) { h = !1 } return h }(),
        Xa = {},
        ua = null,
        kb = function() { this.ctx.clearRect(0, 0, this.width, this.height);
        ...
        lb = function(h, l, v) { l = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= l ? 12 : 11, Math.round(l * (h / 400))) },
        za = function() {
        ...
        mb = function(h) {
            var l = 0 > h;
            if (1 > Math.abs(h)) { var v = parseInt(h.toString().split("e-")[1]);
                v && (h = (l ? -1 * h : h) * Math.pow(10, v - 1), h = "0." + Array(v).join("0") + h.toString().substring(2), h = l ? "-" + h : h) } else v = parseInt(h.toString().split("+")[1]), 20 < v && (v -= 20, h /= Math.pow(10,
        ...
        da = function(h, l, v) {
            ...
            for (var J = 0; E && J < E.length; J++)
                if (l = E[J], "." === l && 0 > N) N = J;
                    ...
                    if ("%" === l) x *= 100;
                    else if ("\u2030" === l) { x *= 1E3; continue } else if ("," === l[0] && "." ===
                        l[l.length - 1]) { x /= Math.pow(1E3, l.length - 1);
                        N = J + l.length - 1; continue } else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (M = !0);
            ...
            for (M = E = J = F = N = 0; 0 < O.length;)
                if (l = O.pop(), "#" === l || "0" === l)
                    if (N++,
                        N === Q) { var $ = x,
                            x = []; if ("0" === l)
                            for (l = Q - F - ($ ? $.length : 0); 0 < l;) $.unshift("0"), l--; for (; 0 < $.length;) v = $.pop() + v, M++, 0 === M % E && (J === S && 0 < $.length) && (v = y + v) } else 0 < x.length ? (v = x.pop() + v, F++, M++) : "0" === l && (v = "0" + v, F++, M++), 0 === M % E && (J === S && 0 < x.length) && (v = y + v);
                ...
                "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) { return Z(U, a.length) }));
            y = "";
            for (O = !1; 0 < L.length;) l = L.shift(), "#" === l || "0" === l ? 0 < h.length && 0 !== Number(h.join("")) ? (y += h.shift(), O = !0) : "0" === l && (y += "0", O = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? y += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? y += l : (l = 0 > U ? l.replace("+", "").replace("-", "") : l.replace("-", ""), y += l.replace(/[0]+/, function(a) { return Z(U, a.length) }));
            v += (O ? w : "") + y;
            return s ? "-" + v : v
        },
        Ma = function(h) { var l = 0,
                v = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (l = h.offsetX, v = h.offsetY) : h.layerX || 0 == h.layerX ? (l = h.layerX, v = h.layerY) : (l = h.pageX - h.target.offsetLeft, v = h.pageY - h.target.offsetTop); return { x: l, y: v } },
        Za = !0,
        ...
        ha = function(h) { for (var l = "", s = 0; s < h.length; s++) l += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(s)); return l },
    ...
    T.prototype.setOptions = function(h, l) { if (na[this._defaultsKey]) { var s = na[this._defaultsKey],
                w; for (w in s) "publicProperties" !== w && s.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : l && w in l ? l[w] : s[w]) } else Fa && window.console && console.log("defaults not set") };
    ...
    T.prototype.createUserOptions = function(h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                this.parent.createUserOptions(), this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var l = this.parent.options[this.optionsName],
                    s = l.length;
                this.options._isPlaceholder || (Ba(l), s = l.indexOf(this.options));
                this.options = "undefined" === typeof h ? {} : h;
                l[s] = this.options } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (s = l.charAt(0).toLowerCase(), 1 < l.length && (s = s.concat(l.slice(1))),
                l = s) : l = void 0, h[l] = this.options
    };
    T.prototype.remove = function(h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var l = this.parent.options[this.optionsName];
            Ba(l); var s = l.indexOf(this.options);
            0 <= s && l.splice(s, 1) } else delete this.parent.options[this.optionsName];
    ...
    T.prototype.trackChanges = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set";
        this.sessionVariables[h] = this.options[h] };
    T.prototype.isBeingTracked = function(h) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[h] ? !0 : !1 };
    T.prototype.hasOptionChanged = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set"; return this.sessionVariables[h] !== this.options[h] };
    ...
    T.prototype.removeEventListener = function(h, l) { if (h && l && this._eventListeners[h])
            for (var s = this._eventListeners[h], w = 0; w < s.length; w++)
                if (s[w].eventHandler === l) { s[w].splice(w, 1); break } };
    T.prototype.removeAllEventListeners = function() { this._eventListeners = [] };
    ...
    Ca.prototype.registerSpace = function(h, l) { "top" === h ? this._topOccupied += l.height : "bottom" === h ? this._bottomOccupied += l.height : "left" === h ? this._leftOccupied += l.width : "right" === h && (this._rightOccupied += l.width) };
    Ca.prototype.unRegisterSpace = function(h, l) { "top" === h ? this._topOccupied -= l.height : "bottom" === h ? this._bottomOccupied -= l.height : "left" === h ? this._leftOccupied -= l.width : "right" === h && (this._rightOccupied -= l.width) };
    ...
    ia.prototype.measureText = function() { this._lineHeight = Wa(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
    ...
    Ta.prototype.get = function(h, l) { var s = null;
        0 < this.pool.length ? (s = this.pool.pop(), Ka(s, h, l)) : s = ra(h, l); return s };
    Ta.prototype.release = function(h) { this.pool.push(h) };
    ma(Ha, T);
    var Na = {
        addTheme: function(h, l) { ab[h] = l },
        addColorSet: function(h, l) { ya[h] = l },
        addCultureInfo: function(h, l) { Ia[h] = l },
        formatNumber: function(h, l, s) { s = s || "en"; if (Ia[s]) return da(h, l || "#,##0.##", new Ha(s)); throw "Unknown Culture Name"; },
    ...
    y = Na.Chart = function() {
        ...
        function l(a, d, c) {
            ...
            (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof ya[this.colorSet] ? ya[this.colorSet] : ya.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                ...
                "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ra(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                    ...
                    ta(b._dropdownMenu) }, this.allDOMEventHandlers), F(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), F(this.overlaidCanvas, window.navigator.msPointerEnabled ?
        ...
        function ca(a, d, c) { ca.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = c;
        ...
        l.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) U(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), pa(this, this._zoomButton, "zoom");
                else {
                    var d = !1;
                    ...
                    F(this._zoomButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers);
                    F(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, pa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, pa(a, a._zoomButton, "pan"));
                    ...
                    F(this._zoomButton, "mouseout", function() { d || (U(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && U(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, this.allDOMEventHandlers)
                }
                this._resetButton ?
                    (U(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (d = !1, ta(this._resetButton = document.createElement("button")), pa(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton),
                        F(this._resetButton, "touchstart", function(a) { d = !0 }, this.allDOMEventHandlers), F(this._resetButton, "click", function() {
                            a.toolTip.hide();
        ...
        l.prototype._updateSize = function() {
            ...
            if (this.canvas.width !== d * ja || this.canvas.height !== c * ja) { for (var b = 0; b < a.length; b++) Ka(a[b], d, c);
        ...
        l.prototype.renderElements = function() {
            ...
            var c = [];
            if (this.animatedRender) { var b = ra(this.width, this.height);
        ...
        l.prototype.render = function(a) { a && (this.options = a);
            this._initialize();
            this.setLayout();
            this.renderElements();
            this._preRenderCanvas && wa(this._preRenderCanvas) };
            ...
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
                    for (var c = null, b = !1, e = null, f = !1, m = 0; m < this.plotInfo.plotTypes.length; m++)
                        if (this.plotInfo.plotTypes[m].type === a.type) { b = !0;
                            c = this.plotInfo.plotTypes[m]; break }
                    b || (c = {
                        type: a.type,
                        totalDataSeries: 0,
                        plotUnits: []
                    ...
                    for (m = 0; m < c.plotUnits.length; m++)
                        if (c.plotUnits[m].axisYType === a.axisYType && c.plotUnits[m].axisXType === a.axisXType && c.plotUnits[m].axisYIndex === a.axisYIndex && c.plotUnits[m].axisXIndex === a.axisXIndex) { f = !0;
                            e = c.plotUnits[m]; break }
                    f || (e = {
                        type: a.type,
        ...
        l.prototype.assignIdToDataPoints = function() { for (var a = 0; a < this.data.length; a++) { var d = this.data[a]; if (d.dataPoints)
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    for (C = 0; C < u.dataPoints.length; C++) {
                        ...
                        if (0 < C) { if (a.axisX.logarithmic) { var r = b / u.dataPoints[C - 1].x;
                                1 > r && (r = 1 / r);
                                c.minDiff > r && 1 !== r && (c.minDiff = r) } else r = b - u.dataPoints[C - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d =
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        if (0 < q) { if (a.axisX.logarithmic) { var l = b / p.dataPoints[q - 1].x;
                                1 > l && (l = 1 / l);
                                c.minDiff > l && 1 !== l && (c.minDiff = l) } else l = b - p.dataPoints[q - 1].x, 0 > l && (l *= -1), c.minDiff > l && 0 !== l && (c.minDiff = l);
                ...
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, m, u = !1, C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    for (n = 0; n < k.dataPoints.length; n++) {
                        ...
                        if ((e = k.dataPoints[n].y) && e.length) { f = Math.min.apply(null, e);
                            ...
                            r = !0; for (var B = 0; B < e.length; B++) null === e.k && (r = !1);
                            r && (p || (h = g), g = b) }
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        f < d.min && (d.min = f);
        ...
        l.prototype.calculateAutoBreaks = function() {
                            ...
                            if (!(4 > h.dataPoints.length))
                                for (u = 0; u < h.dataPoints.length; u++)
                                    if (b && (q = (k + 1 - m) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x, q = Math.floor((g - m) / q), g < f[q].min &&
                                            (f[q].min = g), g > f[q].max && (f[q].max = g)), c) { var l = (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100; if ((g = "waterfall" === a.type ? h.dataPointEOs[u].cumulativeSum : h.dataPoints[u].y) && g.length)
            ...
            for (var b, e = this, f = !1, m = 0; m < this._axes.length; m++)
                if (this._axes[m].scaleBreaks && this._axes[m].scaleBreaks.autoCalculate && 1 <= this._axes[m].scaleBreaks.maxNumberOfAutoBreaks) { f = !0;
                    this._axes[m].dataInfo._dataRanges = []; for (var u = 0; u < 100 / Math.max(parseFloat(this._axes[m].scaleBreaks.collapsibleThreshold) || 10, 10); u++) this._axes[m].dataInfo._dataRanges.push({ min: Infinity, max: -Infinity }) }
            if (f) {
                ...
                for (m = 0; m < this._axes.length; m++)
                    if (this._axes[m].dataInfo._dataRanges) {
                        ...
                        var k = this._axes[m].dataInfo._dataRanges,
                            n, p, f = [];
                        if (this._axes[m].dataInfo.dataPointYPositiveSums) { var q = this._axes[m].dataInfo.dataPointYPositiveSums;
                            n = k; for (u in q)
                                if (q.hasOwnProperty(u) && !isNaN(u) && (p = q[u], !s(p))) { var g = Math.floor((p - C) / b);
                                    p < n[g].min && (n[g].min = p);
                                    p > n[g].max && (n[g].max = p) }
                        ...
                        for (u = 0; u < k.length - 1; u++)
                            if (n = k[u].max, isFinite(n))
                                for (; u < k.length - 1;)
                                    if (C = k[u + 1].min, isFinite(C)) { p = C - n;
                                        p > b && f.push({ diff: p, start: n, end: C }); break } else u++;
                        ...
                        for (u = 0; u < Math.min(f.length, this._axes[m].scaleBreaks.maxNumberOfAutoBreaks); u++) b = a(f[u].start, f[u].end, this._axes[m].logarithmic ? this._axes[m].dataInfo.max / this._axes[m].dataInfo.min : this._axes[m].dataInfo.max - this._axes[m].dataInfo.min, this._axes[m].logarithmic), this._axes[m].scaleBreaks.autoBreaks.push(new X(this, "autoBreaks", b, u, ++this._eventManager.lastObjectId, this._axes[m].scaleBreaks)), this._axes[m].scaleBreaks._appliedBreaks.push(this._axes[m].scaleBreaks.autoBreaks[this._axes[m].scaleBreaks.autoBreaks.length -
                            1]);
                        this._axes[m].scaleBreaks._appliedBreaks.sort(function(a, b) { return a.startValue - b.startValue })
                    }
            }
        };
        ...
        l.prototype.getObjectAtXY = function(a, d, c) { var b = null; if (c = this.getDataPointAtXY(a, d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex];
        ...
        l.prototype.attachEvent = function(a) { this._events.push(a) };
        l.prototype._touchEventHandler = function(a) {
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    e = Ma(b);
                    e.time = new Date;
                    try { var m = e.y - this._lastTouchData.y,
                            f = e.time - this._lastTouchData.time; if (1 < Math.abs(m) && this._lastTouchData.scroll || 5 < Math.abs(m) && 250 > f) this._lastTouchData.scroll = !0 } catch (u) {}
                    this._lastTouchEventType =
                        a.type;
        ...
        l.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                if (2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled)) {
                    ...
                    for (var u = 0; u < this.axisX.length; u++) this.axisX[u].crosshair && this.axisX[u].crosshair.enabled && (this.axisX[u].crosshair.hide(), this.axisX[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX[u].options }, this.axisX[u].crosshair));
                    for (u = 0; u < this.axisX2.length; u++) this.axisX2[u].crosshair && this.axisX2[u].crosshair.enabled && (this.axisX2[u].crosshair.hide(), this.axisX2[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[u].options }, this.axisX2[u].crosshair));
                    for (u = 0; u < this.axisY.length; u++) this.axisY[u].crosshair && this.axisY[u].crosshair.enabled && (this.axisY[u].crosshair.hide(), this.axisY[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[u].options },
                        this.axisY[u].crosshair));
                    for (u = 0; u < this.axisY2.length; u++) this.axisY2[u].crosshair && this.axisY2[u].crosshair.enabled && (this.axisY2[u].crosshair.hide(), this.axisY2[u].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY2[u].options }, this.axisY2[u].crosshair))
            ...
            for (m = 0; m < k.length; m++) {
                ...
                if (isFinite(p.dataInfo.minDiff))
                    if (r = p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                            (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) C.push(p), n.push({ val1: q, val2: g }), u = !0;
                    else if (!e) { u = !1; break }
            }
                        ...
                        for (var A = !1, t = 0; t < n.length; t++)
                            if (s = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))
                                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || A || l) && (c.stroke(), w && b.stroke()), A = !0;
                                    ...
                                    }(n[t].indexLabel || k.indexLabel || n[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: n[t], dataSeries: k, point: { x: s, y: z }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
                        ...
                        for (var A = !1, t = 0; t < n.length; t++)
                            if (s = n[t].getTime ? n[t].x.getTime() : n[t].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !A)))
                                if ("number" !== typeof n[t].y) 0 <
                                    ...
                                    if (0 < n[t].markerSize || 0 < k.markerSize) v = k.getMarkerProperties(t, s, z, c), f.push(v), D = Q(D), w && f.push({ x: s, y: z, ctx: b, type: v.type, size: v.size, color: D, borderColor: D, borderThickness: v.borderThickness });
                                    (n[t].indexLabel || k.indexLabel || n[t].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: n[t], dataSeries: k, point: { x: s, y: z }, direction: 0 > n[t].y === a.axisY.reversed ? 1 : -1, color: r })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
                        ...
                        for (s = !1, l = 0; l < n.length; l++)
                            if (t = n[l].getTime ? n[l].x.getTime() : n[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !s)))
                                if ("number" !== typeof n[l].y) 0 < l && !s && (k.connectNullData ? b.setLineDash && (0 < z.length && (k.options.nullDataLineDashType || !n[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = q, p = k.nullDataLineDashType) :
                                    ...
                                    if (0 < n[l].markerSize || 0 < k.markerSize) { var Oa = k.getMarkerProperties(l, t, s, b);
                                        m.push(Oa);
                                        A = Q(A);
                                        w && m.push({ x: t, y: s, ctx: e, type: Oa.type, size: Oa.size, color: A, borderColor: A, borderThickness: Oa.borderThickness }) }(n[l].indexLabel || k.indexLabel || n[l].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: n[l], dataSeries: k, point: { x: t, y: s }, direction: 0 > n[l].y === a.axisY.reversed ? 1 : -1, color: r });
                                    s = !1
                                }
                    d(z)
                }
        ...
        l.prototype.renderColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: J.yScaleAnimation, easingFunction: J.easing.easeOutQuart, animationBase: k < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : k > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : k }
            }
        };
        l.prototype.renderStackedColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                else if (p = a.axisY.convertValueToPixel(t[k].y), 0 <= t[k].y) { var v = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= v;
                                    A = q - v;
                                    f[b] = v + (A - p) } else v =
                                ...
                                (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter ||
                                    l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: t[k], dataSeries: l, point: { x: n + (z - n) / 2, y: 0 <= t[k].y ? p : A }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: n, y1: Math.min(p, A), x2: z, y2: Math.max(p, A) }, color: b })
                            }
                    }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: J.yScaleAnimation, easingFunction: J.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
        };
                    ...
                    if (0 < t.length)
                        for (var s = 5 < r && l.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                var z = n + r << 0,
                                    A;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = p + ("undefined" !== typeof u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                    p = a.axisY.convertValueToPixel(u[b]);
                                    A = f[b] ? f[b] : q;
                                    f[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] = p + ("undefined" !== typeof C[b] ? C[b] : 0), A = a.axisY.convertValueToPixel(C[b]), p = m[b] ? m[b] : q, m[b] = A;
                                else if (p = a.axisY.convertValueToPixel(p), 0 <= t[k].y) { var v = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= v;
                                    A = q - v;
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y1 - p) && (p = e.y1);
                                    f[b] = v + (A - p) } else v = "undefined" !== typeof m[b] ? m[b] : 0, A = p + v, p = q + v, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - A) && (A = e.y2), m[b] = v + (A - p);
                                b = t[k].color ? t[k].color : l._colorSet[k % l._colorSet.length];
        ...
        l.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? C = r[f].x.getTime() : C = r[f].x, !(C < a.axisX.dataInfo.viewPortMin || C > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y) {
                                ...
                                (r[f].indexLabel ||
                                    g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[f], dataSeries: g, point: { x: 0 <= r[f].y ? m : t, y: u + (l - u) / 2 }, direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(t, m), y1: u, x2: Math.max(t, m), y2: l }, color: b })
                            }
                    }
                }
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: J.xScaleAnimation, easingFunction: J.easing.easeOutQuart, animationBase: k < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : k > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : k }
            }
        };
        l.prototype.renderStackedBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                    0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore());
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: J.xScaleAnimation, easingFunction: J.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
            }
        };
                        ...
                        for (k = 0; k < t.length; k++)
                            if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                                ...
                                p = p - a.plotType.plotUnits.length *
                                    r / 2 + a.index * r << 0;
                                var A = p + r << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) { u[b] = z + (u[b] ? u[b] : 0); if (0 >= u[b]) continue;
                                    z = f[b] ? f[b] : q;
                                    f[b] = n = a.axisY.convertValueToPixel(u[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) C[b] = z + (C[b] ? C[b] : 0), n = m[b] ? m[b] : q, m[b] = z = a.axisY.convertValueToPixel(C[b]);
                                ...
                                (t[k].indexLabel || l.indexLabel || t[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: t[k], dataSeries: l, point: { x: 0 <= t[k].y ? n : z, y: p + (A - p) / 2 }, direction: 0 > t[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(z, n), y1: p, x2: Math.max(z, n), y2: A }, color: b })
                            }
                    }
                }
        ...
        l.prototype.renderArea = function(a) {
            ...
            function b() { v && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? A = z : 0 > a.axisY.viewportMaximum ? A = u.y1 : 0 < a.axisY.viewportMinimum && (A = z), f.lineTo(l, A), f.lineTo(v.x, A), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (m.lineTo(l, A), m.lineTo(v.x, A), m.closePath(), m.fill()), f.beginPath(), f.moveTo(l, t), m.beginPath(), m.moveTo(l, t), v = { x: l, y: t }) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < r.length) {
                        ...
                        c = "solid";
                        if (f.setLineDash) { var I = N(g.nullDataLineDashType, g.lineThickness);
                            c = g.lineDashType; var R = N(c, g.lineThickness);
                            f.setLineDash(R) }
                            ...
                            if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ba)))
                                if ("number" !==
                                    ...
                                    0 !== r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, l,
                                        t, f), C.push(s), Y = Q(Y), w && C.push({ x: l, y: t, ctx: m, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: l, y: t }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: D })
                                }
                        b();
                        $.drawMarkers(C)
                    }
                        ...
                        for (r = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))
                                if ("number" !== typeof p[q].y) 0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < B.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) && (B[B.length - 1].newLineDashArray = x, D = n.nullDataLineDashType) : (d(), B = [])), r = !0;
                                    ...
                                    }(p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: r }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: z });
                                    r = !1
                                }
                        d();
                        $.drawMarkers(m)
        ...
        l.prototype.renderStepArea =
            function(a) {
                ...
                function b() { y && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = z : 0 > a.axisY.viewportMaximum ? v = u.y1 : 0 < a.axisY.viewportMinimum && (v = z), f.lineTo(s, v), f.lineTo(y.x, v), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (m.lineTo(s, v), m.lineTo(y.x, v), m.closePath(), m.fill()), f.beginPath(), f.moveTo(s, t), m.beginPath(), m.moveTo(s, t), y = { x: s, y: t }) }
                var e = a.targetCanvasCtx || this.plotArea.ctx,
        ...
        l.prototype.renderStackedArea =
            function(a) {
                function d() { if (!(1 > k.length)) { for (0 < D.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                            b.lineTo(a.x, a.y);
                            w && s.lineTo(a.x, a.y) }
                        b.closePath();
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) { var y = a.dataSeriesIndexes[v],
                            D = this.data[y],
                            x = D.dataPoints;
                        D.dataPointIndexes = []; for (q = 0; q < x.length; q++) y = x[q].x.getTime ? x[q].x.getTime() : x[q].x, D.dataPointIndexes[y] = q, e[y] || (n.push(y), e[y] = !0);
                        n.sort(Pa) }
                    for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                        ...
                        if (0 < n.length) {
                            ...
                            z = "solid";
                            if (b.setLineDash) { var R = N(D.nullDataLineDashType, D.lineThickness);
                                z = D.lineDashType; var ba = N(z, D.lineThickness);
                                b.setLineDash(ba) }
                                ...
                                if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y)))
                                    if ("number" !== typeof fa.y) D.connectNullData || (Y || B) || d(), Y = !0;
                                        ...
                                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = fa.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                            r = a.axisY.convertValueToPixel(p[f]) } else r = a.axisY.convertValueToPixel(fa.y), r -= la;
                                        k.push({ x: g, y: l - la });
                                        h[f] = l - r;
                                        B || Y ? (!B &&
                                            D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || z === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (B = k.pop(), z = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(z), k.push(B), z = D.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, r), w && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (s.beginPath(), s.moveTo(g, r))), Y = B = !1) : (b.lineTo(g, r), w && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: l - la })));
                                        t = { x: g, y: r };
                                        q < x.length - 1 && (I !== (x[q].lineColor || E) || z !==
                                            (x[q].lineDashType || D.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({ x: g, y: l - la }), I = x[q].lineColor || E, b.strokeStyle = I, b.setLineDash && (x[q].lineDashType ? (z = x[q].lineDashType, b.setLineDash(N(z, D.lineThickness))) : (z = D.lineDashType, b.setLineDash(ba))));
                                        if (0 <= D.dataPointIndexes[f]) { var aa = D.dataPointIds[D.dataPointIndexes[f]];
                                        ...
                                        0 <= D.dataPointIndexes[f] && 0 !== fa.markerSize &&
                                            (0 < fa.markerSize || 0 < D.markerSize) && (la = D.getMarkerProperties(D.dataPointIndexes[f], g, r, b), m.push(la), f = Q(aa), w && m.push({ x: g, y: r, ctx: s, type: la.type, size: la.size, color: f, borderColor: f, borderThickness: la.borderThickness }));
                                        (fa.indexLabel || D.indexLabel || fa.indexLabelFormatter || D.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: D, point: { x: g, y: r }, direction: 0 > x[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                    }
                            }
                            d();
                            b.moveTo(g, r);
        ...
        l.prototype.renderStackedArea100 = function(a) {
            function d() { for (0 < D.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                    b.lineTo(a.x, a.y);
                    w && z.lineTo(a.x, a.y) }
                b.closePath();
                b.globalAlpha = D.fillOpacity;
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) D.connectNullData || (Y || s) || d(), Y = !0;
                                    ...
                                    s || Y ? (!s && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || t === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(l.x, l.y), k.push(t), k.push(s), t = D.nullDataLineDashType, b.setLineDash(R)), b.lineTo(g, r), w && z.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), w && (z.beginPath(), z.moveTo(g,
                                        r))), Y = s = !1) : (b.lineTo(g, r), w && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && z.moveTo(g, r), k.push({ x: g, y: B - aa })));
                                    l = { x: g, y: r };
                                    q < x.length - 1 && (I !== (x[q].lineColor || E) || t !== (x[q].lineDashType || D.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, r), k.push({ x: g, y: B - aa }), I = x[q].lineColor || E, b.strokeStyle = I, b.setLineDash && (x[q].lineDashType ? (t = x[q].lineDashType, b.setLineDash(N(t, D.lineThickness))) : (t = D.lineDashType, b.setLineDash(ba))));
                                    ...
                                    0 <= D.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < D.markerSize) && (aa = D.getMarkerProperties(q, g, r, b), u.push(aa), f = Q(G), w && u.push({ x: g, y: r, ctx: z, type: aa.type, size: aa.size, color: f, borderColor: f, borderThickness: aa.borderThickness }));
                    ...
                    if (0 < n.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++)
                            if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((p - f) * (p - f) + (q - m) * (q - m)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = k.dataPointIds[e], this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: m }, p = Q(p), w && $.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness), (n[e].indexLabel || k.indexLabel ||
                                    n[e].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: n[e], dataSeries: k, point: { x: f, y: m }, direction: 1, bounds: { x1: f - g.size / 2, y1: m - g.size / 2, x2: f + g.size / 2, y2: m + g.size / 2 }, color: null }), p = f, q = m)
                            }
                    }
                }
                w && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
                    ...
                    if (0 < B.length)
                        for (var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < B.length; u++)
                            if (B[u].getTime ? g = B[u].x.getTime() : g = B[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(B[u].y) && B[u].y.length && "number" === typeof B[u].y[0] && "number" === typeof B[u].y[1] && "number" === typeof B[u].y[2] && "number" === typeof B[u].y[3]) {
                                ...
                                (B[u].indexLabel || t.indexLabel || B[u].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: t.type, dataPoint: B[u], dataSeries: t, point: { x: A + (y - A) / 2, y: a.axisY.reversed ? p : n }, direction: 1, bounds: { x1: A, y1: Math.min(n, p), x2: y, y2: Math.max(n, p) }, color: e })
                            }
                }
                        ...
                        for (var A = 5 < r && B.bevelEnabled ? !0 : !1, m = 0; m < z.length; m++)
                            if (z[m].getTime ? g = z[m].x.getTime() : g = z[m].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[m].y) && z[m].y.length && "number" === typeof z[m].y[0] && "number" === typeof z[m].y[1] && "number" === typeof z[m].y[2] &&
                                ...
                                var y = u - r / 2 << 0,
                                    ...
                                    P = B.dataPointIds[m];
                                this._eventManager.objectMap[P] = { id: P, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: m, x1: y, y1: h, x2: D, y2: k, x3: u, y3: n, x4: u, y4: p, y5: q, borderThickness: x, color: e, stemThickness: aa, stemColor: la, whiskerThickness: R, whiskerLength: Y, whiskerColor: I, lineThickness: L, lineColor: M };
                                c.save();
                                ...
                                (z[m].indexLabel || B.indexLabel || z[m].indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: B.type, dataPoint: z[m], dataSeries: B, point: { x: y + (D - y) / 2, y: a.axisY.reversed ? h : p }, direction: 1, bounds: { x1: y, y1: Math.min(h, p), x2: D, y2: Math.max(h, p) }, color: e })
                            }
                }
                        ...
                        if (0 < g.length)
                            for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                                if (g[f].getTime ? h = g[f].x.getTime() : h = g[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
                                    ...
                                    if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: l + (v - l) / 2, y: g[f].y[1] >= g[f].y[0] ? u : m }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: l, y1: Math.min(m, u), x2: v, y2: Math.max(m, u) }, color: b }), this._indexLabels.push({
                ...
                for (var B = 0; B <
                    ...
                    if (0 < x.length)
                        for (var F = A._colorSet, u = 0; u < x.length; u++) {
                            ...
                            var R = { color: x[u].stemColor ? x[u].stemColor : x[u].color ? A.stemColor ? A.stemColor : x[u].color : A.stemColor ? A.stemColor : e, thickness: x[u].stemThickness ? x[u].stemThickness : A.stemThickness, dashType: x[u].stemDashType ? x[u].stemDashType : A.stemDashType };
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                b && n > p &&
                                    (ba = n, n = p, p = ba);
                                ba = A.dataPointIds[u];
                                this._eventManager.objectMap[ba] = { id: ba, objectType: "dataPoint", dataSeriesIndex: z, dataPointIndex: u, x1: Math.min(n, p), y1: Math.min(q, g), x2: Math.max(p, n), y2: Math.max(g, q), isXYSwapped: b, stemProperties: R, whiskerProperties: I };
                        ...
                        for (f = 0; f < r.length; f++)
                            if (r[f].getTime ? k = r[f].x.getTime() : k = r[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(r[f].y) && r[f].y.length && "number" === typeof r[f].y[0] && "number" === typeof r[f].y[1]) {
                                ...
                                w && ea(this._eventManager.ghostCtx, m, a.axisX.reversed ? v : h, u, a.axisX.reversed ? h : v, b, 0,
                                    null, !1, !1, !1, !1);
                                if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[f], dataSeries: g, indexKeyword: 0, point: { x: r[f].y[1] >= r[f].y[0] ? m : u, y: h + (v - h) / 2 }, direction: r[f].y[1] >= r[f].y[0] ? -1 : 1, bounds: { x1: Math.min(m, u), y1: h, x2: Math.max(m, u), y2: v }, color: b }), this._indexLabels.push({
                                    chartType: "rangeBar",
                                    dataPoint: r[f],
                                    dataSeries: g,
                                    indexKeyword: 1,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        ...
                        b.lineWidth = n.lineThickness;
                        var D = "solid";
                        if (b.setLineDash) { var y = N(n.nullDataLineDashType, n.lineThickness),
                                D = n.lineDashType,
                                E = N(D, n.lineThickness);
                            b.setLineDash(E) }
                            ...
                            if (t = p[g].x.getTime ?
                                ...
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || I ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || D === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = E, D = n.nullDataLineDashType,
                                        b.setLineDash(y)), b.lineTo(r, l), w && e.lineTo(r, l), h.push({ x: r, y1: l, y2: s })) : (b.beginPath(), b.moveTo(r, l), v = { x: r, y: l }, h = [], h.push({ x: r, y1: l, y2: s }), w && (e.beginPath(), e.moveTo(r, l))), I = q = !1) : (b.lineTo(r, l), h.push({ x: r, y1: l, y2: s }), w && e.lineTo(r, l), 0 == g % 250 && d());
                                    t = n.dataPointIds[g];
                                    ...
                                    if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: r, y: l }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: z }), this._indexLabels.push({
                                        chartType: "rangeArea",
                                        dataPoint: p[g],
                                        dataSeries: n,
                                        indexKeyword: 1,
            ...
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        d = v(s, 2);
                        b.moveTo(d[0].x, d[0].y);
                        for (g = f = 0; f < d.length - 3; f += 3, g++) { if (s[g].newStrokeStyle || s[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), s[g].newStrokeStyle && (b.strokeStyle = s[g].newStrokeStyle), s[g].newLineDashArray && b.setLineDash(s[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y) }
                        b.stroke()
                    }
                    b.beginPath()
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < n.length) {
                        ...
                        var A = "solid",
                            y;
                        if (b.setLineDash) { var D = N(k.nullDataLineDashType, k.lineThickness),
                                A = k.lineDashType;
                        ...
                        for (g = !1; p < n.length; p++)
                            if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" ===
                                    ...
                                    if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) { var F = k.getMarkerProperties(p, q, g, b);
                                        f.push(F); var I = Q(E);
                                    ...
                                    if (n[p].indexLabel ||
                                        k.indexLabel || n[p].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: t }), this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: r }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: t });
                                    g = !1
                    ...
                    if (0 < v.length)
                        for (var z = 5 < q && s.bevelEnabled ? !0 : !1, x = !1, y = null, D = null, m = 0; m < v.length; m++)
                            if (v[m].getTime ? n = v[m].x.getTime() : n = v[m].x, "number" !== typeof v[m].y) {
                                ...
                                (v[m].indexLabel || s.indexLabel || v[m].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: "waterfall", dataPoint: v[m], dataSeries: s, point: { x: h + (F - h) / 2, y: 0 <= v[m].y ? l : k }, direction: 0 > v[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: h, y1: Math.min(l, k), x2: F, y2: Math.max(l, k) }, color: e })
                            }
                }
        ...
        var ha = function(a, d, c, b, e, f, m, h, l) {
            if (!(0 > c)) {
                ...
                if (!w) { var k = Number((m % (2 * Math.PI)).toFixed(8));
        ...
        l.prototype.renderPie = function(a) {
            function d() {
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        h.midAngle = f;
                        if (h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t) { if (0 === a || g[c].midAngle > h.midAngle) c = e;
                            a++ } else if (h.midAngle >
                            3 * Math.PI / 2 - t && h.midAngle < 3 * Math.PI / 2 + t) { if (0 === b || g[d].midAngle > h.midAngle) d = e;
                            b++ }
                ...
                for (b = 0; b < n.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * D * Math.cos(g[b].midAngle),
                            ...
                            m = !1;
                        if (n[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (z.x + e)) || 1E-9 < Math.abs(g[b].center.y - (z.y + f))) g[b].center.x = z.x + e * a, g[b].center.y = z.y + f * a, m = !0 } else if (0 < Math.abs(g[b].center.x - z.x) || 0 < Math.abs(g[b].center.y - z.y)) g[b].center.x = z.x + e * (1 - a), g[b].center.y = z.y + f * (1 - a),
                            m = !0;
            ...
            function h() {
                ...
                if (l.subtitles)
                    for (var a = 0; a < l.subtitles.length; a++) { var b = l.subtitles[a];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== x) {
                    ...
                    }, function() { l.disableToolTip = !1;
                        l._animator.animate(0, l.animatedRender ? 500 : 0, function(a) { c(a);
                            h();
                            l.dispatchEvent("dataAnimationIterationEnd", { chart: l }) });
                        l.dispatchEvent("dataAnimationEnd", { chart: l }) })
                }
        ...
        var na = function(a, d, c, b) { "undefined" === typeof c && (c = 1);
        ...
        l.prototype.renderFunnel =
            function(a) {
                function d() { for (var a = 0, b = [], c = 0; c < B.length; c++) { if ("undefined" === typeof B[c].y) return -1;
                        B[c].y = "number" === typeof B[c].y ? B[c].y : 0;
                        a += Math.abs(B[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < B.length; c++) b.push(Math.abs(B[c].y) * E / a); return b }
                ...
                function c() {
                    ...
                    f = Math.abs(f);
                    f = d + f;
                    for (var d = [], g = 0, k = 0; k < B.length; k++) { if ("undefined" === typeof B[k].y) return -1;
                ...
                function b() {
                    if (t && B) {
                        for (var a, b, c, d, e, f, k, m, h, n, p, q, l, u, r, C = [], v = [], z = { percent: null, total: null }, y = null, A = 0; A < B.length; A++) r = P[A],
                        ...
                        for (var A = 0, D = B.length - 1; A < B.length || 0 <= D; A++, D--) {
                            ...
                            Q.roundRect || Aa(Q);
                            c = new ia(Q, { fontSize: f, fontFamily: m, fontColor: e, fontStyle: k, fontWeight: h, horizontalAlign: c, textAlign: u, backgroundColor: d, maxWidth: l, maxHeight: !1 === v[A] ? q ? 4.28571429 * f : 1.5 * f : v[A], text: b, padding: da });
                            c.measureText();
                            H.push({ textBlock: c, id: t.reversed ? D : A, isDirty: !1, lineColor: a, lineThickness: n, lineDashType: p, height: c.height < c.maxHeight ? c.height : c.maxHeight, width: c.width < c.maxWidth ? c.width : c.maxWidth })
                        }
                    }
                }
                ...
                function e() {
                    ...
                    e = !1;
                    c = 0;
                    for (var g, k = L - Z - S / 2, k = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > k ? k : t.indexLabelMaxWidth : k, m = H.length - 1; 0 <= m; m--) { g = B[H[m].id];
                        c = H[m];
                        d = c.textBlock;
                ...
                function m() {
                    ...
                    function b() {
                        ...
                        for (k = P.length - 1; 0 < k; k--)
                            if (!H[k].isDirty) { e = p(k); if (0 > e && (e = 0, H[e].isDirty)) break; if (H[k].textBlock.y < H[e].textBlock.y + H[e].height) { d = d || k;
                                    f = k; for (m = 0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + da;) { a = a || H[f].textBlock.y + H[f].height;
                                        m += H[f].height;
                                        m += da;
                                        f = e; if (0 >= f) { f = 0;
                                            m += H[f].height; break }
                                        e = p(f); if (0 > e) { f = 0;
                                            m += H[f].height; break } } if (f != k) { g = H[f].textBlock.y;
                                        a -= g;
                                        a = m - a;
                                        g = c(a, d, f); break } } }
                        return g
                ...
                function h(a, b) { return (b < P.length ? H[b].textBlock.y : t.reversed ? V + A : qa + A) - (0 > a ? t.reversed ? qa - A : V - A : H[a].textBlock.y + H[a].height + da) }
                ...
                function l(a, b, c) {
                    ...
                    if (0 === W.length) m = ha;
                        ...
                        for (var q = 0; q < P.length; q++) {
                            if (1 == W.length && 0 == W[0]) { if (0 === q) { m.push(ha[q]);
                                    d = h; continue } } else 0 ===
                                q && (d = -1 * h);
                            m.push(ha[q] + d);
                    ...
                    g = function() { for (var a = [], b = 0; b < P.length; b++) a.push(m[b] - P[b].y1); return a }();
                    var u = {
                        startTime: (new Date).getTime(),
                        duration: c || 500,
                        easingFunction: function(a, b, c, d) { return J.easing.easeOutQuart(a, b, c, d) },
                    ...
                    a._animator.animate(0, c, function(c) { var d = a.plotArea.ctx || a.ctx;
                        ...
                        u.changeSection(c, b); var e = {};
                        e.dataSeries = t;
                        e.dataPoint = t.reversed ? t.dataPoints[B.length - 1 - b] : t.dataPoints[b];
                        e.index = t.reversed ? B.length - 1 - b : b;
                        a.toolTip.highlightObjects([e]); for (e = 0; e < P.length; e++) na(d, P[e], t.fillOpacity);
                        v(d);
                        I && ("inside" !== t.indexLabelPlacement ? n(d) : f(), r(d));
                        1 <= c && (ga = !1) }, null, J.easing.easeOutQuart)
                }

                function k() { for (var a = 0, b = 0; b < P.length - 1; b++)(0 <= W.indexOf(b) || 0 <= W.indexOf(b + 1)) && a++; return a }
                ...
                function q(a) { for (a += 1; a <= P.length && a != P.length && H[a].isDirty; a++); return a }

                function g(a) { for (var b, c = 0; c < B.length; c++)
                ...
                function r(a) { for (var b = 0; b < P.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0)) }
                    ...
                    if (0 != t.length && (t.dataPoints && t.visible) && 0 !== B.length) {
                        ...
                        if (-1 !== R) {
                            ...
                            for (G = 0; G < R.length - 1; G++) T = t.reversed ? B[B.length - 1 - G].color ? B[B.length - 1 - G].color : t._colorSet[(B.length - 1 - G) % t._colorSet.length] : B[G].color ? B[G].color : t._colorSet[G % t._colorSet.length],
                                G === ca ? P.push({ x1: a[G], y1: F[G], x2: y[G], y2: F[G], x3: $, y3: va, x4: y[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: K, y6: va, id: G, height: F[G + 1] - F[G], color: T }) : P.push({ x1: a[G], y1: F[G], x2: y[G], y2: F[G], x3: y[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: T });
                            var da = 2,
                                H = [],
                                ga = !1,
                                W = [],
                            ...
                            if (I && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) { m(); for (G = 0; G < B.length; G++) H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (L - a) / 2, 0 == G && (D = a), D > a && (D = a)); for (G = 0; G < P.length; G++) P[G].x1 += D, P[G].x2 += D, P[G].x3 += D, P[G].x4 += D, P[G].x5 && (P[G].x5 += D, P[G].x6 += D), H[G].textBlock.x += D }
                            ...
                            if (!I)
                                for (G = 0; G < B.length; G++) D = t.dataPointIds[G],
                                    a = { id: D, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: P[t.reversed ? B.length - 1 - G : G] }, x._eventManager.objectMap[D] = a;
                            ...
                            return { source: Q, dest: this.plotArea.ctx, animationCallback: function(a, b) { J.fadeInAnimation(a, b);
                                    1 <= a && (l(x, -1, 500), v(x.plotArea.ctx || x.ctx)) }, easingFunction: J.easing.easeInQuad, animationBase: 0 }
                        }
                    }
                }
            };
        ...
        l.prototype.set = function(a, d, c) { c = "undefined" === typeof c ? !0 : c; "options" === a ? (this.options = d, c && this.render()) : l.base.set.call(this, a, d, c) };
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    if (c.percentFormatString) l = c.percentFormatString;
                            ...
                            k = Math.max(Math.ceil(Math.log(1 / Math.abs(m)) / Math.LN10), 2); if (isNaN(k) || !isFinite(k)) k = 2; for (var n = 0; n < k; n++) l += "#";
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try { var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (m = Ea(g[2]), a = Ea(g[1])) } catch (k) {}
                g = null;
        ...
        E.prototype.setLayout = function() {
                ...
                for (n = 0; n < l.length; n++) {
                    ...
                    if (!(0 >= m || "undefined" === typeof m || 0 >= w || "undefined" === typeof w)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!p || p.width + Math.round(q.textBlock.width + v + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) p = { items: [], width: 0 }, k.push(p), this.height += g, g = 0;
                            ...
                            "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < m - this.lineHeight ? (p = { items: [], width: 0 }, k.push(p)) : (p = k[x], x = (x + 1) % k.length), this.height += q.textBlock.height;
            ...
            this.items = l;
            for (n = 0; n < this.items.length; n++) q = l[n], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex };
            this.markerSize = v;
            this.rows = k;
        ...
        L.prototype.getDataPointAtX =
            function(a, d) {
                ...
                for (;;) { f = 0 < m ? n + e : n - e; if (0 <= f && f < this.dataPoints.length) { var b = this.dataPoints[f],
                            p = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
                        p < c.distance && (c.dataPoint = b, c.distance = p, c.index = f);
                        b = p;
                        b <= h ? h = b : 0 < m ? l++ : k++; if (1E3 < l && 1E3 < k) break } else if (0 > n - e && n + e >= this.dataPoints.length) break; - 1 === m ? (e++, m = 1) : m = -1 }
        ...
        x.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) / Math.log(d / this.viewportMinimum) <
                    this.noTicks - 1) { for (var c = x.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) b < this.viewportMinimum || this.logLabelValues.push(b);
        ...
        x.prototype.createLabels = function() {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            n = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: n, label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ? this.labels[n] : da(n, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: m,
            ...
            for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock;
                a.maxWidth = f;
                a.maxHeight = m; var r = a.measureText();
                l = r.height }
            e = [];
            q = p = 0;
            ...
            for (g = 0; g < q.length; g++)
                ...
                if ("normal" === e) {
                    for (var x = [], z = [], A = [], y = [], M = [], N = [], O = [], Q = []; 4 >
                        ...
                        if (b && 0 < b.length)
                            for (g = 0; g < b.length; g++) b[g] && (m = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), l = Math.round(m), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + X + W < Math.max(K, p) ? Math.max(K, p) : f.y1 + X + W), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (T + e + K)), b[g].lineCoordinates = { x1: m + U, y1: h, x2: m + U, y2: k, height: Math.abs(k - h) }, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (y[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2, b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2), b[g].bounds = { x1: m, y1: h, x2: l + (y[g] + U), y2: k, width: l - m, height: k - h }, b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.height ? b[g].titleMaxWidth :
        ...
        x.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines &&
                ...
                for (var d = this, c, b = 0, e = 0, f = !1, m = !1, h = [], l = [], m = !1, b = 0; b < this.stripLines.length; b++) { var k = this.stripLines[b];
        ...
        x.prototype.renderCrosshair = function(a, d) { isFinite(this.minimum) && isFinite(this.maximum) && (this.crosshair.render(a, d), this.crosshair.dispatchEvent("updated", { chart: this.chart, crosshair: this.options, axis: this, value: this.crosshair.value }, this)) };
        ...
        x.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
            this.sessionVariables.newViewportMaximum = this.viewportMaximum = Math.max(a, d) };
        x.prototype.getXValueAt = function(a) { if (!a) return null; var d = null; "left" === this._position ? d = this.convertPixelToValue(a.y) : "bottom" === this._position && (d = this.convertPixelToValue(a.x)); return d };
                ...
                if (this.scaleBreaks)
                    for (h = 0; h < this.scaleBreaks._appliedBreaks.length; h++)
                        if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) && (!s(this.sessionVariables.newViewportMaximum) &&
                                this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue || !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue)) { this.scaleBreaks._appliedBreaks.splice(h, 1); break }
        ...
        x.getNiceExponent = function(a, d) { var c = Math.floor(Math.log(a) / Math.LN10),
                b = a / Math.pow(10, c),
                b = 0 > c ? 1 >= b ? 1 : 5 >= b ? 5 : 10 : Math.max(Math.floor(b), 1); return -20 > c ? Number(b * Math.pow(10, c)) : Number((b * Math.pow(10, c)).toFixed(20)) };
        x.getNiceNumber = function(a, d) { var c = Math.floor(Math.log(a) / Math.LN10),
                b = a / Math.pow(10, c),
        ...
        ma(V, T);
        ma(X, T);
        X.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
            ...
            if (0 !== this.spacing ||
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, h = 1 === p % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 +
                            p / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: l }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(h, l), this.ctx.lineTo(h, e);
                    ...
                    for (q = 0; q < n; q++) this.ctx.bezierCurveTo(s + f * a, k - a, s + f * a, k - 2 * a, s, k - 3 * a), k -= 3 * a, f *= -1
                        ...
                        k = e + a;
                        s = b + a;
                        n = (l - k) / a / 2; for (q = 0; q < n; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(s, k);
                        s += h - b; for (q = 0; q < n + 1; q++) this.ctx.lineTo(s, k), s += 2 * f * a, k -= 2 * a, f *= -1;
                        this.ctx.lineTo(s + f * a, k + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" === this.scaleBreaks.parent._position)
                    if (e = 1 === p % 2 ? (e.y << 0) + 0.5 : e.y <<
                        0, l = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, h = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, h = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: l + p / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(h, e), this.ctx.lineTo(h, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
                    ...
                    k = e - a;
                    s = b + a;
                    n = (h - s) / a / 2; for (q = 0; q < n; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s += 2 * a, f *= -1;
                    this.ctx.lineTo(s, k);
                    k += l - e; for (q = 0; q < n + 1; q++) this.ctx.lineTo(s, k), k += 2 * f * a, s -= 2 * a, f *= -1;
        ...
        O.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: l };
        ...
        ca.prototype.hide = function() { this.chart.resetOverlayedCanvas();
            this.chart.renderCrosshairs(this.parent);
            this._hidden = !0 };
        ca.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.y[b] }) : s(this.options.label) ? da(s(c) ? B.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                            ...
                            this.value = z;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.y }) : s(this.options.label) ?
                            ...
                            this.value = A;
                            k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: A }) : s(this.options.label) ? da(s(c) ? A : c, this.valueFormatString, this.chart._cultureInfo) : this.label
                        ...
                        if (A) { if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), w = null, y = 0; y < this.parent.dataSeries.length; y++)(w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x }) : s(this.options.label) ? w.dataPoint.label : this.label) } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: B.dataPoint.x
                        }) : s(this.options.label) ? za(B.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x }) : s(this.options.label) ? da(B.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (A) { if ("axisX" === this.parent.type)
                            for (r = this.parent.convertPixelToValue({ x: a }), w = null, y = 0; y < this.parent.dataSeries.length; y++)(w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.x }) : s(this.options.label) ? w.dataPoint.label : this.label) } else "dateTime" === this.parent.valueType ?
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: B.dataPoint.y[b] }) : s(this.options.label) ? da(s(c) ? B.dataPoint.y[b] : c, this.valueFormatString,
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, h = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = h = v = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - p / 2, x2: e, y2: h + p / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" ===
                        ...
                        if (A) {
                            if ("axisX" === this.parent.type)
                                for (r = this.parent.convertPixelToValue({ y: d }), w = null, y = 0; y < this.parent.dataSeries.length; y++)(w = this.parent.dataSeries[y].getDataPointAtX(r, !0)) && 0 <= w.index && (k.text = this.labelFormatter ? this.labelFormatter({
                                    chart: this.chart,
                                    axis: this.parent.options,
                                    crosshair: this.options,
                                    value: s(c) ? this.parent.convertPixelToValue(a) : c
                                }) : s(this.options.label) ? w.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(d) : c }) : s(this.options.label) ? za(s(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position) k.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s(c) ? this.parent.convertPixelToValue(a) : c }) : s(this.options.label) ? da(s(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo) : this.label, k.x = b - k.measureText().width /
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index;
                        ...
                        if (b = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < b && "undefined" !== typeof this.chart._eventManager.objectMap[b]) { b = this.chart._eventManager.objectMap[b]; if ("legendItem" === b.objectType) return;
        ...
        Z.prototype.enableAnimation = function() { if (!this.container.style.WebkitTransition) { var a = this.getContainerTransition(this.containerTransitionDuration);
        ...
        ga.prototype.reset = function() { this.lastObjectId = 0;
            this.objectMap = [];
            this.rectangularRegionEventSubscriptions = [];
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
        ...
        ga.prototype.mouseEventHandler = function(a) {
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                for (c = 0; c < d.length; c++) { e = !1; for (b = 0; b < this.mouseoveredObjectMaps.length; b++)
                        if (d[c].id === this.mouseoveredObjectMaps[b].id) { e = !0; break }
                    e || (this.fireEvent(d[c], "mouseover", a), this.mouseoveredObjectMaps.push(d[c])); "click" === a.type ? this.fireEvent(d[c], "click", a) : "mousemove" === a.type && this.fireEvent(d[c], "mousemove", a) }
            }
        };
        ...
        W.prototype.cancelAllAnimations = function() { this.animations = [];
        ...
        var J = {
                ...
                xScaleAnimation: function(a, d) { if (0 !== a) { var c = d.dest,
                            b = d.source.canvas,
                            e = d.animationBase;
